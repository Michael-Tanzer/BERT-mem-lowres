...
def f1_score(y_true, y_pred, average='micro', suffix=False):
    ...
    if average == "micro":
        ...
        return score
    elif average == "macro" or average == "weighted" or average is None or average.lower() == "none":
        true_entities = set(get_entities(y_true, suffix))
        pred_entities = set(get_entities(y_pred, suffix))
        ...
        if average == "macro":
            ...
            return np.average(f1s, weights=s)
        elif average is None or average.lower() == "none":
            return zip(f1s, s)
    else:
        raise ValueError
...
def precision_score(y_true, y_pred, average='micro', suffix=False):
    ...
    if average == "micro":
        ...
        if average == "macro":
            ...
            return np.average(ps, weights=s)
        elif average is None or average.lower() == "none":
            return zip(ps, s)
    else:
        raise ValueError
...
def recall_score(y_true, y_pred, average='micro', suffix=False):
    ...
    if average == "micro":
        ...
        if average == "macro":
            ...
            return np.average(rs, weights=s)
        elif average is None or average.lower() == "none":
            return zip(rs, s)
    else:
        raise ValueError
